...
public class WeChatUtil {
    ...
    public static final String TEMPLE_MESSAGE_SUBMITTED = "3COMTrL4TYAvxpcphp-14eop26fpkEOOYSZkyb5jI5g";
    public static final String TEMPLE_MESSAGE_PROCESSED = "V0KeA1QZRFSY6R6PtKvy-FlN8dUTqQkqUQ6AioiRGLY";
